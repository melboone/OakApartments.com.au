<?php $title = 'Oak Appartments'; include("includes/header.php"); ?>
<div class="container bg2 menu2">
	<div class="wrapper">
		<div class="menu"><?php require($DOCUMENT_ROOT . "includes/menu.php"); ?></div>
		<div class="content"><?php require($DOCUMENT_ROOT . "includes/pages/architecture.php"); ?></div>
	</div>
</div>
